...
function FounderSection() {
    return (
        <>
            <section className="py-12 founder-gradient relative">
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row items-center gap-8 md:px-28">
                        ...
                        <div className="w-full md:w-3/4 text-center md:text-left">
                            <p className="text-xl font-bold text-white mb-2">Founder & Managed Under Visionary Leadership</p>
                            ...
                            <div className="flex justify-center md:justify-start gap-3 mt-2">
                                <a href="#" className="text-white hover:text-[#492974]">
                                    <svg
