        ...
        <>
            <div className="py-12">
                <div className="container mx-auto px-4">
                    <h2 className="text-2xl font-bold mb-2">RX100 Recommended Properties</h2>
                    <p className="text-gray-400 mb-8">Top handpicked projects for you exclusively by RX100</p>
