                ...
                <div className="max-w-7xl">
                    <div className="flex flex-wrap justify-center md:justify-start">
                        {["BUY", "RENT", "SELL", "PROJECTS"].map((tab) => (
                            <button
                                key={tab}
                                className={`px-4 py-2 sm:px-6 cursor-pointer w-32 md:w-40 text-sm sm:text-base font-bold rounded-t-2xl text-white ${
                ...
                <div className="max-w-7xl mx-auto px-2 sm:px-4">
                    <div className="flex flex-col md:flex-row gap-4 items-stretch">
                        ...
                        <div className="w-full md:w-auto">
                            <button className="w-full md:w-16 h-14 bg-black text-white rounded-2xl flex items-center justify-center">
