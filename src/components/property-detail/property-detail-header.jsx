            ...
            <div className="container mx-auto px-4 md:mt-28 mt-20">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-white text-xl font-medium mt-2">Talawali Chanda, Indore, M P</p>
                    </div>
                    <div className="flex items-center mt-2 md:mt-0 space-x-4">
                        <button className="flex items-center cursor-pointer border-2 border-white bg-[#1a1333] hover:bg-[#2a1f45] px-3 py-1.5 rounded-lg">
